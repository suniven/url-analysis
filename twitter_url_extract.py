...
#     notsure_df = pd.DataFrame(notsure, columns=['url'])
#     notsure_df.to_csv('./notsure.csv', index=False)
...
def main():
    ...
    url_unique_df = url_df.drop_duplicates()
    url_unique_df.to_csv('./urls_unique.csv', index=False)
